...
public class Sm2Util {
    ...
    public static byte[] sign( Sm2PrivateKey priKey, byte[] srcData )
        ...
        // ParametersWithRandom pwr = new
        // ParametersWithRandom(priKey.getPrivateKeyParameters(), new
        // SecureRandom());
        ParametersWithRandom pwr = new ParametersWithRandom(priKey.getPrivateKeyParameters());
        if (withId != null) {
