...
public final class CookieCsrfTokenRepository implements CsrfTokenRepository {
	...
	@Override
	public void saveToken(CsrfTokenBean token, HttpServletRequest request, HttpServletResponse response) {
	 ...
	 * cookie will only be marked as HttpOnly if both <code>cookieHttpOnly</code> is
	 * <code>true</code> and the underlying version of Servlet is 3.0 or greater.
	 * Defaults to <code>true</code> if the underlying version of Servlet is 3.0 or
	 * greater. NOTE: The {@link Cookie#setHttpOnly(boolean)} was introduced in
	 * Servlet 3.0.
	 *
	 * @param cookieHttpOnly <code>true</code> sets the HttpOnly attribute,
	 *                       <code>false</code> does not set it (depending on
	 *                       Servlet version)
	 * @throws IllegalArgumentException if <code>cookieHttpOnly</code> is
	 *                                  <code>true</code> and the underlying version
	 *                                  of Servlet is less than 3.0
	 */
