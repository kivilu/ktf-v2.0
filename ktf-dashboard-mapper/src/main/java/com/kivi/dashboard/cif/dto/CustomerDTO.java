...
@ApiModel(value="CustomerDTO对象", description="客户信息")
public class CustomerDTO implements Serializable {
	...
	@ApiModelProperty(value = "用户头像，最后一个数值代表正方形头像大小（有0、46、64、96、132数值可选，0代表132*132正方形头像），用户没有头像时该项为空。若用户更换头像，原有头像URL将失效。")
	...
	@ApiModelProperty(value = "客户状态，0:enabled,1:locked,2:disabled,3:processing,4:deleted,5:freezed,9:init")
