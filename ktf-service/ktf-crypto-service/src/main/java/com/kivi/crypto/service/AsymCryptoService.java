...
public interface AsymCryptoService {
	 ...
	 * @return
	 */
	KeyPairDO genKeyPair();

	/**
	 * 1.0 公钥加密
	 * 
	 * @param ctxToken rsa context token
	 * @param data 明文数据
	 * @return
	 */
	 ...
	 * @return
	 */
	AsymCtx asymCtx(String ctxToken);
