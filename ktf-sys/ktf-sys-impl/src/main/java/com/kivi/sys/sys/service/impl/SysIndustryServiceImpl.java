...
import com.kivi.sys.sys.mapper.SysIndustryExMapper;
...
public class SysIndustryServiceImpl extends ServiceImpl<SysIndustryMapper, SysIndustry> implements SysIndustryService {
    ...
    public Boolean removeWithChildren(List<Long> ids) {
        QueryWrapper<SysIndustry> wrapper = new QueryWrapper<>();
        wrapper.in(SysIndustry.DB_PID, ids);
        this.remove(wrapper);
        return this.removeByIds(ids);
    }
