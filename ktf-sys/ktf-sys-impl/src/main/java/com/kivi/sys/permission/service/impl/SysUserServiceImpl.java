...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    @Autowired
    private ICifCustomerAuthsService customerAuthsService;
    ...
    @Override
    public long count(KmsUserType... types) {
        List<Integer> list = Arrays.asList(types).stream().map(KmsUserType::getCode).collect(Collectors.toList());
        LambdaQueryWrapper<SysUser> queryWrapper = Wrappers.<SysUser>lambdaQuery();
        queryWrapper.in(SysUser::getUserType, list);
