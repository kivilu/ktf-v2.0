...
import com.kivi.sys.sys.service.ISysApi3rdpartyService;
...
public class SysApi3rdpartyServiceImpl extends ServiceImpl<SysApi3rdpartyMapper, SysApi3rdparty>
    implements ISysApi3rdpartyService {
    ...
    public SysApi3rdpartyDTO getByWxAppId(String appid) {
        ...
        SysApi3rdparty ent = super.getOne(query);

        return BeanConverter.convert(SysApi3rdpartyDTO.class, ent);
    }
