...
public class SysIndustryDubboServiceImpl extends ServiceImpl<SysIndustryMapper, SysIndustry>
    ...
    public Boolean removeById(Long id) {
        return sysIndustryService.removeById(id);
    }

    @Override
    public Boolean removeByIds(List<Long> ids) {
        return sysIndustryService.removeByIds(ids);
    }

    @Override
    public Boolean removeWithChildren(Long id) {
        return sysIndustryService.removeWithChildren(id);
    }

    @Override
    public Boolean removeWithChildren(List<Long> ids) {
        return sysIndustryService.removeWithChildren(ids);
    }
