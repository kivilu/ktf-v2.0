...
public class SysRegionDubboServiceImpl extends ServiceImpl<SysRegionMapper, SysRegion> implements SysRegionService {
    ...
    public Boolean removeById(Long id) {
        return sysRegionService.removeById(id);
    }

    @Override
    public Boolean removeWithChildren(Long id) {
        return sysRegionService.removeWithChildren(id);
    }

    @Override
    public Boolean removeWithChildren(List<Long> ids) {
        return sysRegionService.removeWithChildren(ids);
    }
