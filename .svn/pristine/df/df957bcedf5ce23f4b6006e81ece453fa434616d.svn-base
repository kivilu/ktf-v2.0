...
public class ShiroConfig {
	...
	public SecurityManager securityManager(
			@Autowired ShiroRedisCacheManager shiroRedisCacheManager,
			@Autowired ShiroRedisSessionDAO shiroRedisSessionDAO) {
		DefaultWebSecurityManager securityManager = new DefaultWebSecurityManager();
		// 设置realm.
		securityManager.setRealm(shiroDBRealm(shiroRedisCacheManager));
		// 注入Session管理器
	 ...
	 */
	@Bean
	public ShiroDBRealm shiroDBRealm(@Autowired ShiroRedisCacheManager shiroRedisCacheManager) {
